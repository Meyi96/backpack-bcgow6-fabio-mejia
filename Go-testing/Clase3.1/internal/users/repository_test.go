...
import (
	...
	"github.com/Meyi96/backpack-bcgow6-fabio-mejia/Go-testing/Clase3.1/internal/domain"
...
func TestRepositoryStore(t *testing.T) {
	...
	// Act.
	result, err := repo.Store(25, expUser.Name, expUser.LastName, expUser.Email, expUser.Age, expUser.Height, expUser.Active, expUser.CreationDate)
...
func TestRepositoryStorewritindingError(t *testing.T) {
	...
	// Act.
	result, err := repo.Store(25, "", "", "", 0, 0, false, time.Time{})
...
func TestRepositoryUpdatewritindingError(t *testing.T) {
	...
	// Act.
	result, err := repo.Update(25, "", "", "", 0, 0, false)
...
func TestRepositoryUpdateLastNameAndAge(t *testing.T) {
	...
	// Act.
	result, err := repo.UpdateLastNameAndAge(25, expUser.LastName, expUser.Age)
...
func TestRepositoryUpdateLastNameAndAgewritindingError(t *testing.T) {
	...
	// Act.
	result, err := repo.UpdateLastNameAndAge(25, "", 0)
